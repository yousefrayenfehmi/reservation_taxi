export const en = {
  ...
  contact: {
    ...
    contact_info: {
      ...
      address: {
        title: "Address",
        street: "123 Champs-Élysées Avenue",
  ...
  cgv: {
    ...
    sections: {
     ...
     footer: {
       copyright: "© 2024 TAXI RESERVATION. All rights reserved.",
