...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg transition-all duration-300 z-50 flex items-center gap-2 hover:scale-110"
